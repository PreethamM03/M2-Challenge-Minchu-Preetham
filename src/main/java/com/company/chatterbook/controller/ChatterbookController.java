...
public class ChatterbookController {
    ...
    @RequestMapping(value = "/user/{index}/chats", method = RequestMethod.GET)
    public List<ChatterPost> getUserChats(@PathVariable int index) {
        return userList.get(index).getChatterPosts();
    }
}
